...
/*******************************************************************************
 * Private APIs for "HAL LCD DRIVER"
 ******************************************************************************/
 ...
 *
 * Param [in]        - Pre-defined Commands @ref LCD_COMMAND
 *
 * Retval            - None
 *
 * Note              - None
 ******************************************************************************/
static void HAL_LCD_Void_WriteCommand(uint8_t);

/*******************************************************************************
 * Fn                - setPinsAndTriggerPulse
 *
 * Brief             - Send data/command then latch it with an enable pulse
 *
 * Param [in]        - Data/Command to be sent
 *
 * Retval            - None
 *
 * Note              - None
 ******************************************************************************/
static void setPinsAndTriggerPulse(uint8_t);

/*******************************************************************************
 * Fn                - delay_ms
 *
 * Brief             - Simple for loop delay
 *
 * Param [in]        - Number to loop for
 *
 * Retval            - None
 *
 * Note              - None
 ...
 * Fn                - enablePulse
 *
 * Brief             - Output a pulse to the enable pin
 *
 * Param [in]        - None
 *
 * Retval            - None
